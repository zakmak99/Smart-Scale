...
class DietPlanLoseAdapter(private val itemList: List<FoodItem>) : RecyclerView.Adapter<DietPlanLoseAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.activity_lose_list, parent, false)
